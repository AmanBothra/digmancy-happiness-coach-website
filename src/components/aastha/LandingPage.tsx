...
type LandingPageProps = {
  registrationMode?: "paid" | "free";
};

const LandingPage = ({ registrationMode = "paid" }: LandingPageProps) => {
  ...
  const isFreeRegistration = registrationMode === "free";
  ...
  const registrationFormCta = isFreeRegistration
    ? "Reserve My Spot"
    : `Reserve My Spot — Pay ${registrationPrice}`;
            ...
            <div className="min-w-0 animate-fade-up">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3">
                <Button variant="cta" size="xl" className={responsiveCtaClass} onClick={openRegistration}>
                  <PriceCtaContent
                    label={isFreeRegistration ? "Reserve My Spot" : "Save My Seat"}
                    compareAtPrice={compareAtPrice}
                    registrationPrice={registrationPrice}
                    showPrice={!isFreeRegistration}
                  />
                </Button>
              </div>
            </div>
      ...
      <section className="py-24 lg:py-32 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="container relative max-w-3xl text-center">
          ...
          <div className="mt-12 flex flex-col items-center gap-6">
            ...
            <Button variant="cta" size="xl" className={responsiveCtaClass} onClick={openRegistration}>
              <PriceCtaContent
                label={isFreeRegistration ? "Reserve My Spot" : "Don't miss out"}
                compareAtPrice={compareAtPrice}
                registrationPrice={registrationPrice}
                showPrice={!isFreeRegistration}
              />
